"""
Django settings for restless_tree_dev_70586 project.
...
ROOT_URLCONF = 'restless_tree_dev_70586.urls'
...
WSGI_APPLICATION = 'restless_tree_dev_70586.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_tree_dev_70586 API",
    "DESCRIPTION": "API documentation for restless_tree_dev_70586 App",
    "VERSION": "v1",
}
